...
namespace QuGo.Web.Framework.Security
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, Inherited = true, AllowMultiple = false)]
    public class QuGoHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public QuGoHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                case SslRequirement.Yes:
                    {
                        ...
                        if (!currentConnectionSecured)
                        {
                            ...
                            if (storeContext.CurrentApplication.SslEnabled)
                            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new SysException("Not supported SslProtected parameter");
            }
        }

...
using QuGo.Web.Framework.Kendoui;
using QuGo.Web.Framework.Localization;
using QuGo.Web.Framework.UI;

namespace QuGo.Web.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual int GetActiveStoreScopeConfiguration(IApplicationService applicationService, IWorkContext workContext)
        {
            ...
            var applicationId = workContext.CurrentUser.GetAttribute<int>(SystemUserAttributeNames.AdminAreaApplicationScopeConfiguration);
            var application = applicationService.GetApplicationById(applicationId);
            return application != null ? application.Id : 0;
        }
        ...
        {
            string dataKey = string.Format("qugo.notifications.{0}", type);

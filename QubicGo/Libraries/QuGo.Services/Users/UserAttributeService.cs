...
namespace QuGo.Services.Users
{
    ...
    public partial class UserAttributeService : IUserAttributeService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string CUSTOMERATTRIBUTES_ALL_KEY = "QuGo.userattribute.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : user attribute ID
        /// </remarks>
        private const string CUSTOMERATTRIBUTES_BY_ID_KEY = "QuGo.userattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : user attribute ID
        /// </remarks>
        private const string CUSTOMERATTRIBUTEVALUES_ALL_KEY = "QuGo.userattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CUSTOMERATTRIBUTEVALUES_BY_ID_KEY = "QuGo.userattributevalue.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERATTRIBUTES_PATTERN_KEY = "QuGo.userattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERATTRIBUTEVALUES_PATTERN_KEY = "QuGo.userattributevalue.";
        #endregion
        ...
        {
            string key = string.Format(CUSTOMERATTRIBUTEVALUES_ALL_KEY, userAttributeId);
            return _cacheManager.Get(key, () =>
            {
        ...
        public virtual UserAttributeValue GetUserAttributeValueById(int userAttributeValueId)
        {
            ...
            string key = string.Format(CUSTOMERATTRIBUTEVALUES_BY_ID_KEY, userAttributeValueId);

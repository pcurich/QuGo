...
namespace QuGo.Services.Users
{
    ...
    public partial class UserService : IUserService
    {
        ...
        /// </remarks>
        private const string USERROLES_ALL_KEY = "QuGo.userrole.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : system name
        /// </remarks>
        private const string USERROLES_BY_SYSTEMNAME_KEY = "QuGo.userrole.systemname-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string USERROLES_PATTERN_KEY = "QuGo.userrole.";
        ...
        public virtual IPagedList<User> GetAllUsers(DateTime? createdFromUtc = null,
            DateTime? createdToUtc = null, int[] userRoleIds = null, string email = null, 
        ...
        public virtual void DeleteUser(User user)
        {
            ...
            if (user.IsSystemAccount)
                throw new SysException(string.Format("System user account ({0}) could not be deleted", user.SystemName));
        ...
        public virtual void DeleteUserRole(UserRole userRole)
        {
            ...
            if (userRole.IsSystemRole)
                throw new SysException("System role could not be deleted");

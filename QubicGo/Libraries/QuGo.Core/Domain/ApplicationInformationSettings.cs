...
namespace QuGo.Core.Domain
{
    public class ApplicationInformationSettings : ISettings
    {
        /// <summary>
        ...
        /// </summary>
        public string DefaultApplicationTheme { get; set; }
        ...
        /// </summary>
        public bool DisplayMiniProfilerInPublicApplication { get; set; }

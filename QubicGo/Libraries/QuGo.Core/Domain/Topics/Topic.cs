...
namespace QuGo.Core.Domain.Topics
{
    /// <summary>
    /// Represents a topic
    /// </summary>
    public partial class Topic : BaseEntity, ILocalizedEntity, ISlugSupported, IApplicationMappingSupported, IAclSupported
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the value indicating whether this topic is accessible when a application is closed
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the entity is limited/restricted to certain applications
        /// </summary>

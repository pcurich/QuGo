...
namespace QuGo.Core.Configuration
{
    /// <summary>
    /// Represents a SysConfig
    /// </summary>
    public partial class SysConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var supportPreviousSysVersionsNode = section.SelectSingleNode("SupportPreviousSysVersions");
            config.SupportPreviousSysVersions = GetBool(supportPreviousSysVersionsNode, "Enabled");
        ...
        /// </summary>
        public bool SupportPreviousSysVersions { get; private set; }

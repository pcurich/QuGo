...
using QuGo.Core.Infrastructure.Mapper;
...
namespace QuGo.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class SysEngine : IEngine
    {
        #region Fields
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(SysConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// <summary>
        /// Initialize components and plugins in the Sys environment.
        /// </summary>
        /// <param name="config">Config</param>
